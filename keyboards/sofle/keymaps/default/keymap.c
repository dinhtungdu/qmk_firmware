...
LSFT_T(KC_F13), KC_Z,          KC_X,           KC_C,           KC_V,           KC_B, KC_MUTE,          XXXXXXX, KC_N,    KC_M,           KC_COMM,        KC_DOT,         KC_SLSH,      RSFT_T(KC_F24),
                LSG_T(KC_F14), LALT_T(KC_F15) ,LCTL_T(KC_F16), LGUI_T(KC_F17), LT(_LOWER,KC_F18),    LT(_LOWER, KC_F19), RGUI_T(KC_F20), RCTL_T(KC_F21), RALT_T(KC_F22), C_S_T(KC_F23)
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT(
  ...
  KC_F13,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, _______,       _______, _______, _______, _______, _______,  _______, KC_F24,
